...
class Chick(pygame.sprite.Sprite):
    ...
    def move(self, speed, score):
        ...
        if speed:
            None  # Pointless statment to make pylint happy 
...
class Worm(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect = self.surf.get_rect(
            center=(random.randint(40, view_board.SCREEN_WIDTH-40), 0))
    ...
    def move(self, speed, score):
        ...
        if self.rect.bottom > 700:
            ...
            self.rect.center = (random.randint(
                40, view_board.SCREEN_WIDTH - 20), 0)
        return score
